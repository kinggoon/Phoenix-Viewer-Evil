...
#define DLH_FILTER L"DanceList ( *.dancelist)\0*.dancelist\0"
//</edit>
...
//<sumo>
	case FFSAVE_DLH:
		if(filename.empty())
		{
			wcsncpy( mFilesW,L"untitled.dancelist", FILENAME_BUFFER_SIZE);
		}
		mOFN.lpstrDefExt = L".dancelist";
		mOFN.lpstrFilter =
			L"InvCache (*.dancelist)\0*.dancelist\0" \
			L"\0";
		break;
//</sumo>
